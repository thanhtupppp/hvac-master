  ...
  static double toWatts(double value, PowerUnit from) {
    switch (from) {
      case PowerUnit.w:
        return value;
      case PowerUnit.kw:
        return value * _wPerKw;
      case PowerUnit.mw:
        return value * _wPerMw;
      case PowerUnit.btuHr:
        return value * _wPerBtuHr;
      case PowerUnit.ton:
        return value * _wPerTon;
      case PowerUnit.hp:
        return value * _wPerHp;
      case PowerUnit.kcalHr:
        return value * _wPerKcalHr;
    }
  }
  ...
  static double fromWatts(double watts, PowerUnit to) {
    switch (to) {
      case PowerUnit.w:
        return watts;
      case PowerUnit.kw:
        return watts / _wPerKw;
      case PowerUnit.mw:
        return watts / _wPerMw;
      case PowerUnit.btuHr:
        return watts / _wPerBtuHr;
      case PowerUnit.ton:
        return watts / _wPerTon;
      case PowerUnit.hp:
        return watts / _wPerHp;
      case PowerUnit.kcalHr:
        return watts / _wPerKcalHr;
    }
  }
