...
const FIREBASE_ERROR_MAP: Record<string, string> = {
  ...
  "auth/too-many-requests":
    "Tài khoản bị tạm khóa do nhập sai nhiều lần. Vui lòng thử lại sau.",
...
export default function LoginPage() {
  ...
  const handleForgotPassword = async () => {
    if (!email) {
      setError(
        "Vui lòng nhập địa chỉ email trước để gửi liên kết khôi phục mật khẩu.",
      );
      return;
    }
    setError("");
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="z-10 space-y-4">
          ...
          <p className="text-slate-400 text-lg max-w-md">
            Công cụ quản lý bài viết hướng dẫn mã lỗi, sơ đồ mạch điện và tài
            liệu sửa chữa điện lạnh đa ngôn ngữ tích hợp AI.
          </p>
        </div>
